...
class YOLOWorldHead(YOLOv8Head):
    ...
    def predict_by_feat(self,
        ...
        """
        with record_function("YW-predict-bbox-boxhead-init"):
        ...
        with record_function("YW-predict-bbox-boxhead-scores"):
        ...
        results_list = []
        with record_function("YW-predict-bbox-boxhead-core"):
            for (bboxes, scores, objectness,
                ...
                with record_function("YW-predict-bbox-boxhead-core-topk"):
                ...
                if rescale:
                    with record_function("YW-predict-bbox-boxhead-core-rescale"):
                ...
                with record_function("YW-predict-bbox-boxhead-core-postprocess"):
                    results = self._bbox_post_process(results=results,
                                                      cfg=cfg,
                                                      rescale=False,
                                                      with_nms=with_nms,
                                                      img_meta=img_meta)
                with record_function("YW-predict-bbox-boxhead-core-clamp"):
